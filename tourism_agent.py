...
# Main loop
print(
    "Welcome to Enhanced Kashmir Tourism AI Agent! Ask about attractions, best time, safety, tips, accommodations, cuisine, or request an itinerary. Type 'exit' to quit.")
while True:
